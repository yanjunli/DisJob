...
import com.hqyg.disjob.common.exception.WebProcessingException;
import com.hqyg.disjob.common.exception.WebUserExistsException;
...
public class BaseController {
	...
	public Result exception(Exception e) {
		...
		}else if(e instanceof EjobFrameWorkException){
			msg = e.getMessage();
		}
		else {

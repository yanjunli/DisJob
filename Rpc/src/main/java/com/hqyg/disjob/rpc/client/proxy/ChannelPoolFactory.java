 ...
 *
 */
public class ChannelPoolFactory extends BasePooledObjectFactory<com.hqyg.disjob.rpc.client.proxy.Channel> {
	 ...
	 */
	@Override
	public com.hqyg.disjob.rpc.client.proxy.Channel create() throws Exception {
	...
	@Override
	public PooledObject<Channel> wrap(com.hqyg.disjob.rpc.client.proxy.Channel obj) {

package com.hqyg.disjob.rpc.client.handler;
...
public class EjobKillResponseHandler extends SimpleChannelInboundHandler<EjobResponse> {

	private final boolean autoRelease;
	public PhpTaskCmd cmd;
	
 	public EjobKillTaskResponse response;
  
 	public CountDownLatch downLatch;
	public EjobKillResponseHandler(PhpTaskCmd cmd,EjobKillTaskResponse response,CountDownLatch downLatch ) {
 		autoRelease = true;
 		this.cmd = cmd;
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
		...
		try {
			if (acceptInboundMessage(msg)) {
				EjobKillTaskResponse msgResponse = (EjobKillTaskResponse)msg;

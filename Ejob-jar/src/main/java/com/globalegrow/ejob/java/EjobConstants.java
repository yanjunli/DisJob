...
public final class EjobConstants {
	public static final boolean isDebug = false ;
	
	public final class Config{
		public static final String EJOB_CONFIG_PATH = "ejobConfig" ;//这个给不是spring 应用程序用的
		...
		public static final String EJOB_THREADPOOL_CFG = "ejobCfg" ;
		
		public static final String EJOB_CLUSTER_NAME = "cluster.name";

package com.hqyg.disjob.java.spring.parser;
...
import com.hqyg.disjob.java.core.startup.EjobSpringStartUp;
import com.hqyg.disjob.java.utils.StringUtils;
 
public class EjobSpringCfgBeanDefinitionParser implements BeanDefinitionParser {
	
	private final static Class<EjobSpringStartUp> clazz = EjobSpringStartUp.class;
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		startupBean.setBeanClassName("com.hqyg.disjob.java.core.startup.EjobSpringStartUp");
		startupBean.setBeanClass(EjobSpringStartUp.class);

...
package com.hqyg.disjob.common.log;
...
public class DefaultLogService implements LogService {
    ...
    private static Logger ejobStats = LoggerFactory.getLogger("ejobStats");
    ...
    public void accessStatsLog(String format, Object... argArray) {
    	ejobStats.info(format, argArray);
    }
    ...
    public boolean isStatsEnabled() {
        return ejobStats.isInfoEnabled();
    }
}

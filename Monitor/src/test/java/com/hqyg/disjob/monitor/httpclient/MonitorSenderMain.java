package com.hqyg.disjob.monitor.httpclient;

import java.io.UnsupportedEncodingException;

import com.hqyg.disjob.monitor.rms.MonitorClient;
import com.hqyg.disjob.monitor.rms.MonitorRequest;
import com.hqyg.disjob.monitor.rms.MonitorResponse;
import com.hqyg.disjob.monitor.rms.SendInfo;
...
public class MonitorSenderMain {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		String[][] testArrays = new String[][]{
			{"Ejob_services","SJC93229","230101","RqDcKC1BYNIORNZ6ndZ4"},	//t
			{"Ejob_services","SJC93229","220112","RqDcKC1BYNIORNZ6ndZ4"},	//f
			{"Ejob_services","SJC51876","220110","RqDcKC1BYNIORNZ6ndZ4"},	//f
			{"Ejob_services","SJC93005","230401","RqDcKC1BYNIORNZ6ndZ4"},	//t
			{"Ejob_services","SJC93005","230402","RqDcKC1BYNIORNZ6ndZ4"},	//t
			
			{"Ejob_services","SJC31808","220111","RqDcKC1BYNIORNZ6ndZ4"},	//t
			{"Ejob_services","SJC31808","220113","RqDcKC1BYNIORNZ6ndZ4"},	//t
			{"Ejob_services","SJC31808","220114","RqDcKC1BYNIORNZ6ndZ4"},	//t

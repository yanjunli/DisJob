package com.hqyg.disjob.monitor.db.dynamicsql;

import java.util.List;

import org.apache.ibatis.jdbc.SQL;

import com.hqyg.disjob.monitor.util.DatePart;
...
public class StatisticsSqlProvider {
	...
	public enum DBTable{
		JobBasicInfoTable("ejob_job_basicinfo"),
		JobProgressTable("ejob_job_exeprogress");//进度表
		private String name;

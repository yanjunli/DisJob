 ...
 * </pre>
 */
public class EjobServerInfo implements Serializable,Comparable<EjobServerInfo>{
    ...
    public EjobServerInfo(String ip) {
        this.ip = ip;
    }
    
    public EjobServerInfo(String ip, int weight) {
        super();
        this.ip = ip;
        this.weight = weight;
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        EjobServerInfo other = (EjobServerInfo) obj;
        if (ip == null)
        {
            if (other.ip != null)
                return false;
	...
	@Override
	public int compareTo(EjobServerInfo o) {

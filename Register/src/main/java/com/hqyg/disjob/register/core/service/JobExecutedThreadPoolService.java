...
import com.hqyg.disjob.register.core.RpcParameter;
import com.hqyg.disjob.register.core.action.UpdateLastFireTimeAction;
...
import com.hqyg.disjob.rpc.action.SchedulerJobAction;
...
import com.hqyg.disjob.rpc.utils.RpcSpringWorkFactory;
...
public class JobExecutedThreadPoolService {
	...
	public void init(){
		...
		try {
			...
			LoggerUtil.error("com.hqyg.disjob.register.core.service.impl.GeneralSchedulerServiceImpl.init() not connect zk");
		}
    ...
    public void submit(com.hqyg.disjob.register.domain.Job job){
    ...
    public static void main(String[] args) {
    	HURL  hurl = new HURL("group","ejob://","localhost",9501,"test job","/test.php","","null","1.0.0",null);

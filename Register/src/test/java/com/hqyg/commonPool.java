...
import com.hqyg.disjob.register.job.EjobServerServiceImpl;
...
public class commonPool extends BaseJunitTest{
	...
	@Resource
	public   EjobServerServiceImpl initServerExecuteJobService;
 ...
 CuratorFramework client = null;
	...
	public void testBorrow() throws TransportException{
		  ...
		  HURL hurl = new  HURL("oms4", "ejob", "10.40.6.100", 9501, "ctestjob1");
	        final RpcClient client = com.hqyg.disjob.rpc.client.proxy.RpcClientCache.get(hurl);
